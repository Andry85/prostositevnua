...
# Скопировать SALT и заменить две нижние константы можно здесь http://get-simple.info/api/security/
# SALT для защиты пароля. По умолчанию пусто для обратной совместимости.
# define('GSLOGINSALT', 'your_unique_phrase');

# Отключает автоматическую генерацию и позволяет использовать пользовательский SALT для cookies и загрузок.
