...
$i18n = array(
  ...
  , 'token' => "The message has already been sent."
  ...
  , 'config_title' => "Simple-C configuration"
  , 'config_updated' => "Your changes were saved successfully."
  , 'config_error_open' => "<b>Unable to open config file.</b> 
Check if the file exists and its permissions :"
  , 'config_error_modify' => "<b>Unable to modify config file.</b> 
Check the file permissions :"
  ...
  , 'forum' => "Forum"
  , 'enable' => "Enable"
  , 'enable_sub' => "Enable or disable mail sending (doesn't hide the contact forms)."
  , 'default_email' => "Default email"
  , 'default_email_sub' => "Leave empty to let it set to"
  , 'lang' => "Language"
  , 'lang_sub' => "Default language is set to"
  , 'default_params' => "Default parameters"
  , 'default_params_sub' => "Default tag form structrure. Use syntax described in documentation."
  ...
  , 'blacklist' => "Blacklist"
  , 'whitelist' => "Whitelist"
  , 'checklists_sub' => "Blacklist : values that must not be present in the field to send email.<br />
...
Separated by commas."
  ...
  , 'debug' => "Debug mode"
  , 'debug_sub' => "Disable mail sending, display Simple-C data structure, data sent by POST and 
