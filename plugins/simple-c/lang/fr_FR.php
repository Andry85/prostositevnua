...
$i18n = array(
  ...
  , 'config_title' => "Configuration de Simple-C"
  , 'config_updated' => "Vos modifications ont été enregistrées avec succès."
  , 'config_error_open' => "<b>Impossible d'ouvrir le fichier de configuration.</b> 
Vérifiez s'il existe et ses permissions :"
  , 'config_error_modify' => "<b>Impossible de modifier le fichier de configuration.</b> 
Vérifiez ses permissions :"
  ...
  , 'forum' => "Forum"
  , 'enable' => "Activer"
  , 'enable_sub' => "Active ou désactive l'envoi de mail (ne cache pas les formulaires)."
  ...
  , 'default_params_sub' => "Structure des formulaires pour les balises par défaut.
Utilisez la syntaxe décrite dans la documentation."
  ...
  , 'checklists_sub' => "Liste noire : valeurs qui ne doivent pas être présentes dans un champ pour envoyer le mail.<br />
...
Séparées par des virgules."
  ...
  , 'debug' => "Mode debug"
  , 'debug_sub' => "Désactive l'envoi de mails, affiche la structure de données de Simple-C, 
