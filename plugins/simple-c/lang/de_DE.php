...
$i18n = array(
  ...
  , 'config_title' => "Simple-C Konfiguration"
  , 'config_updated' => "Erfolgreich eingestellt."
  , 'config_error_open' => "<b>Konfigurationsdatei nicht lesbar.</b> 
Datei eventuell anlegen und Rechte einstellen :"
  , 'config_error_modify' => "<b>Konfigurationsdatei nicht beschreibbar.</b> 
Rechte einstellen :"
  ...
  , 'forum' => "Forum"
  , 'enable' => "Aktivieren"
  , 'enable_sub' => "E-Mail-Versand ein- oder ausschalten."
  ...
  , 'blacklist' => "Blacklist"
  , 'whitelist' => "Whitelist"
  , 'checklists_sub' => "Blacklist : Verbotene Werte.<br />
Whitelist : Erlaubte Werte.<br />
Durch Kommata abgetrennt."
  , 'general_fields' => "Allgemeine Felder"
  , 'special_fields' => "Besondere Felder"
  , 'debug' => "Debugmodus"
  , 'debug_sub' => "E-Mail versand deaktiveren, Datenstruktur von Simple-C anzeigen, Daten per POST verschickt und 
